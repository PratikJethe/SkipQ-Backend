...
export const userRegisterValidation = [
    ...
    check('pincode','Invalid pincode value').optional().exists({checkFalsy:true}).isNumeric().withMessage('Invalid pincode').matches(/^[1-9][0-9]{5}$/).withMessage('Invalid 6 digit pincode'),
